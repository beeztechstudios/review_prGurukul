...
const moodsList = [
  { key: "happy", label: "Happy", icon: Smile, color: "text-green-700", bg: "bg-green-100", border: "border-green-300" },
  { key: "sad", label: "Sad", icon: Frown, color: "text-blue-700", bg: "bg-blue-100", border: "border-blue-300" },
  { key: "angry", label: "Angry", icon: AlertCircle, color: "text-red-700", bg: "bg-red-100", border: "border-red-300" },
  { key: "excited", label: "Excited", icon: Zap, color: "text-yellow-700", bg: "bg-yellow-100", border: "border-yellow-300" },
